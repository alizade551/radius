...
<body class="<?=( $sideBar == "false" ) ? "sidebar-noneoverflow" : "" ?>" >
    ...
    <div class="header-container fixed-top">
        <header class="header navbar navbar-expand-sm <?=( $sideBar == "false" ) ? "expand-header" : "" ?>">
            
            <ul class="navbar-nav theme-brand flex-row  text-center">
 
                <li class="nav-item theme-text">
                    <a href="/" class="nav-link"> <?=$siteConfig['name'] ?> </a>
                </li>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                <li class="nav-item dropdown apps-dropdown more-dropdown md-hidden" style="width:120px">
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                <div class="toggle-switch" style="display: block; line-height: 28px; margin-top: 20px; margin-right: 10px;">
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="">
                                                    ...
                                                    <p class="msg-title"><?=Yii::t('app', 'Contract number is empty! Please fill it for online payments')?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="">
                                                    <h5 class="usr-name"> <?=$key + 1?>.<?=$value['fullname'] ?></h5>
                                                    <p class="msg-title"><?=Yii::t('app', '{customer} is using temporary service with special permission',['customer'=>$value['fullname']])?> </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="">
                                                    ...
                                                    <p class="msg-title"><?=Yii::t('app', 'Continued Credit Not complate')?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="">
                                                    <h5 class="usr-name"> <?=$key + 1?>.<?=$value['item_name']?></h5>
                                                    <p class="msg-title"><?=Yii::t('app', 'Continued gift Not complate')?> <?=$gift_con['item_name']?> </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            ...
                            <?php endif?>
                                <img src="<?=$photo_url ?>" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
                                    <h5><?=Yii::$app->user->fullname ?></h5>
                                     <?php if ( Yii::$app->user->isSuperadmin ): ?>
                                        <p class=""><?=Yii::t("app","Superadmin") ?></p>
                                     <?php else: ?>
                                        <p class=""><?=Yii::$app->user->userRole[0] ?></p>
                                     <?php endif?>
                                </div>
                            </div>
                        </div>
            ...
            <nav id="sidebar" aria-expanded="true">
                <ul class="list-unstyled menu-categories" id="accordionExample"> 
                    ...
                    <li class="menu <?php if( $controller_name == "request-order" ){echo "active";} ?>">
                        <a href="/request-order/index" aria-expanded="false" class="dropdown-toggle" style="position: relative;">
                            <div class="">
                    ...
                    <?php if ( User::canRoute("/users/index") || User::canRoute("/online-users/index") ): ?>
                        <li class="menu <?php if( $controller_name == "users" || $controller_name == "online-users" ){echo "active";} ?>">
                            ...
                            <ul class="collapse submenu list-unstyled <?php if( $controller_name == "users" || $controller_name == "online-users" ){
                                ...
                                <?php if ( User::canRoute("/online-users/index") ): ?>
                                    <li class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "online-users/index"){echo "active";} ?>">
                                        <a href="/online-users/index"> <?=Yii::t("app","Online customers") ?> </a>
                                    </li>
                                <?php endif ?>
                    ...
                    <?php if ( User::canRoute("/user-damages/index") ): ?>
                        <li class="menu <?php if( $controller_name == "active-reports" || $controller_name == "user-damages" ){echo "active";} ?>">
                            <a href="#reports" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" style="position: relative;">
                                <div class="">
                    ...
                    <?php if (  User::canRoute("/routers/index") || User::canRoute("/packets/index") || User::canRoute("/devices/index") || User::canRoute("/radacct-all/index") || User::canRoute("/radpostauth/index") ): ?>
                        <li class="menu <?php if( $controller_name == "radacct-all" || $controller_name == "radpostauth" || $controller_name == "routers" || $controller_name == "packets" || $controller_name == "devices" || $controller_name == "users-voip" || $controller_name == "ip-adresses" ){echo "active";} ?> " >
                            <a href="#network" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                <div class="">
                            ...
                            <ul class="collapse submenu list-unstyled <?php if( $controller_name == "radacct-all" || $controller_name == "radpostauth" || $controller_name == "routers" || $controller_name == "packets" || $controller_name == "devices" || $controller_name == "users-voip" || $controller_name == "ip-adresses"  ){echo "collapse ".$extraActiveClass;} ?> " id="network" data-parent="#accordionExample">
                                ...
                                <?php if ( User::canRoute("/radacct-all/index") ): ?>
                                <li class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "radacct-all/index" ){echo "active";} ?>">
                                    <a href="/radacct-all/index"> <?=Yii::t("app","Radius accounting") ?> </a>
                                </li>
                                <?php endif ?>

                                <?php if ( User::canRoute("/radpostauth/index") ): ?>
                                <li class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "radpostauth/index" ){echo "active";} ?>">
                                    <a href="/radpostauth/index"> <?=Yii::t("app","Radius Auth Request") ?> </a>
                                </li>
                                <?php endif ?>
                    ...
                    <li class="menu <?php if( $controller_name == "user-balance" || $controller_name == "receipt" || $controller_name == "bonus" || $controller_name == "currencies" ){echo "active";} ?> ">
                        ...
                        <ul class="collapse submenu list-unstyled <?php if( $controller_name == "user-balance" || $controller_name == "bonus" || $controller_name == "currencies" || $controller_name == "receipt" ){echo "collapse ".$extraActiveClass;} ?> " id="payments" data-parent="#accordionExample">
                            ...
                            <li class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "user-balance/payment-calculator" ){echo "active";} ?>">
                                <a href="/user-balance/payment-calculator"> <?=Yii::t('app','Calculator') ?> </a>
                            </li>
                            <?php endif ?> 
                     ...
                     <li class="menu <?php if( $controller_name == "items" || $controller_name == "item-category" || $controller_name == "item-stock" || $controller_name == "item-usage" || $controller_name == "warehouses" ){echo "active";} ?> ">
                        <a href="#warehouses" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu <?php if( $controller_name == "cities" || $controller_name == "district" || $controller_name == "locations" ){echo "active";} ?>">
                        <a href="#locations" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled <?php if( $controller_name == "cities" || $controller_name == "district" || $controller_name == "locations" ){echo "collapse ".$extraActiveClass;}   ?>" id="locations">
                            ...
                            <li class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "locations/index" ||  $controller_name."/".Yii::$app->controller->action->id == "locations/create" || $controller_name."/".Yii::$app->controller->action->id == "locations/update" ){echo "active";} ?>">
                  ...
                  <li class="menu <?php if( $controller_name == "users-history" || $controller_name == "users-note" || $controller_name == "logs"  || $controller_name == "cron-logs"){echo "active";} ?>">
                    ...
                    <li class="menu <?php if( $controller_name == "user" || $controller_name == "language" || $controller_name == "personal-activty" || $controller_name == "user-visit-log" || $controller_name == "cron-logs" || $controller_name == "role" || $controller_name == "permission"  ){echo "active";} ?>">
                        ...
                        <ul class="collapse submenu list-unstyled <?php if( $controller_name == "user"  || $controller_name == "language" || $controller_name == "personal-activty" || $controller_name == "user-visit-log" || $controller_name == "cron-logs" || $controller_name == "role" || $controller_name == "permission" ){echo "collapse ".$extraActiveClass;}   ?>" id="admin" data-parent="#accordionExample">
                            <li>
                                ...
                                <ul class="collapse list-unstyled sub-submenu <?php if( $controller_name == "user" || $controller_name == "personal-activty" || $controller_name == "user-visit-log" ){echo "collapse show";} ?>" id="users" data-parent="#admin"> 
                                  ...
                                  <?php if ( User::canRoute("/user-management/user") ): ?>
                                        <li class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "user/index" ){echo "active";} ?>">
                            ...
                            <li  class="<?php if( $controller_name."/".Yii::$app->controller->action->id == "language/index" || $controller_name."/".Yii::$app->controller->action->id == "language/create" || $controller_name."/".Yii::$app->controller->action->id == "language/update" ){echo "active";} ?>">
                    ...
                    <li class="menu  <?php if($controller_name."/".Yii::$app->controller->action->id == "site/config"){echo "active";} ?> ">
                        <a href="/site/config" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
...
$this->registerJs('
   ...
   $(document).on("pjax:send", function() {
    ...
    $(".breadcrumb-item.parent a").on("click",function(){
        let parent = $(this).data("menu_id");
        if(parent){
            $("html").addClass("mini_bar-open sidebar-noneoverflow")
            $("body").addClass("mini_bar-open sidebar-noneoverflow")
            $("#container").addClass("sbar-open")
            $("#container").removeClass("sidebar-closed")
            $("body").addClass("sidebar-noneoverflow")
            $("#compact_submenuSidebar").toggleClass("show")
            $(".overlay").toggleClass("show")
            $("#compact_submenuSidebar .submenu" ).removeClass("show")
            $("#compact_submenuSidebar #"+parent ).addClass("show")
        }
    })
    ...
    var onresize = function() {
      ...
      if( height < 552 ){
        $(".menu-categories").height(height-140);
      }
    }
    window.addEventListener("resize", onresize);
    if( $(window).height() < 740 ){
        $(".menu-categories").height($(window).height()-140);
