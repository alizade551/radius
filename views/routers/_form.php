...
<?php $form = ActiveForm::begin(['id'=>'router-form']); ?>
    <div class="row">
        ...
        <div class="col-sm-6">
             <?= $form->field($model, 'vendor_name')->dropDownList( ['CISCO' => 'CISCO', 'MIKROTIK' => 'MIKROTIK','JUNIPER'=>'JUNIPER'],[
        ...
        <div class="col-sm-6">
            <div class="router-password-container" >
                <?= $form->field($model, 'secret')->passwordInput(['maxlength' => true]) ?>
        ...
        <div class="col-sm-6">
            ...
            if (Yii::$app->request->get('city_id')) {
               ...
               echo  $form->field($model, 'district_id')->dropDownList(ArrayHelper::map(\app\models\District::find()
                ...
                ',
                'prompt'=>Yii::t("app","Select")])->label("District");  
            }
...
$("#show-router-password").on("click",(e)  => {
	let password_input = $("#nas-secret");
	let text = $("#show-router-password");
	let password_input_type = $("#nas-secret").attr("type");
