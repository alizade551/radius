                ...
                <ul class="list-unstyled menu-categories" id="accordionExample"> 
                    ...
                    <?php if (  User::canRoute("/routers/index") || User::canRoute("/packets/index") || User::canRoute("/devices/index") || User::canRoute("/radacct-all/index") || User::canRoute("/radpostauth/index") ): ?>
                        <li class="menu <?php if( $controller_name == "radacct-all" || $controller_name == "radpostauth" || $controller_name == "routers" || $controller_name == "packets" || $controller_name == "devices" || $controller_name == "users-voip" || $controller_name == "ip-adresses" ){echo "active";} ?> " >
                            ...
                            <?php if ( User::canRoute("/routers/index") || User::canRoute("/packets/index") || User::canRoute("/ip-adresses/index")  || User::canRoute("/radacct-all/index") || User::canRoute("/radpostauth/index") || User::canRoute("/users-voip/index") || User::canRoute("/devices/index") ): ?>
                                <a href="#network" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle" <?php if( $controller_name == "radacct-all" || $controller_name == "radpostauth" || $controller_name == "routers" || $controller_name == "packets" || $controller_name == "devices" || $controller_name == "users-voip" || $controller_name == "ip-adresses" ){echo 'data-active="true" aria-expanded="true"';} ?> >
                                    <div class="">
