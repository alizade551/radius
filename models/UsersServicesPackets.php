...
class UsersServicesPackets extends DefaultActiveRecord
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [
                'connect_type', 'required', 'when' => function($model) {
            ...
            [
                'packet_login', 'required', 'when' => function($model) {
                if (isset($model->service->service_alias)) {
                    if ( $model->service->service_alias == "internet" && $model->connect_type == "ipoe" ) {
                         return true;
                    }
                    return false;
                }
                ...
                },'message'=>Yii::t('app','Mac address can not be blank')
            ],
