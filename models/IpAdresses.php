...
class IpAdresses extends \yii\db\ActiveRecord
{
   ...
   const SCENARIO_CREATE = 'create';
     ...
     public function scenarios(){
        ...
        $scenarios[self::SCENARIO_CREATE] = ['start_ip','end_ip','type','split'];
        return $scenarios;
    }
    ...
    {
        return [
            [[ 'nas_id','type'], 'required'],
            [['start_ip','end_ip','public_ip','type'], 'required', 'on' => self::SCENARIO_CREATE],
