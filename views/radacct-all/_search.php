...
/* @var $model app\models\search\RadacctAllSearch */
...
<div class="radacct-search">
    ...
    <?php // echo $form->field($model, 'framedipv6address') ?>

    <?php // echo $form->field($model, 'framedipv6prefix') ?>

    <?php // echo $form->field($model, 'framedinterfaceid') ?>

    <?php // echo $form->field($model, 'delegatedipv6prefix') ?>
