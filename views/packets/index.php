                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                            ...
                            [
                              ...
                              'visible'=>User::canRoute(["/packets/add-attribute"]),
                              'template' => '{add-attribute}',
                                'buttons' => [
                                    'add-attribute' => function ($url, $model) {
                                        if ( $model['service_alias'] == "internet" ) {
                                        $langUrl = (Yii::$app->language == "en") ? "" : "/".Yii::$app->language."/";
                                            return Html::a('<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>',$url,[
                                                'data'=>['pjax'=>0],'class'=>'modal-d','style'=>'display:block;text-align:center','title'=>Yii::t('app','Add an attribute for {packet_name}',['packet_name'=>$model['packet_name']])
                                            ]);
                                        }else{
                                            return '<div  style="text-align:center;display:block"><svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><circle cx="12" cy="12" r="10"></circle><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"></line></svg></div>';
