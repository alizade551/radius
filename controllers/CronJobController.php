                ...
                if ($packet['users_status'] == "2") {
                    ...
                    if ($packet['service_alias_name'] == "internet") {
                       ...
                       if($packet['u_p_static_ip'] != ""){
                          ...
                          \app\models\radius\Radreply::deleteStaticIp( $packet['user_inet_login'], $packet['static_ip'] );
                        }
                        \app\models\radius\Radusergroup::deleteRadUserGroup( $packet['user_inet_login'] );
                        \app\models\radius\Radcheck::deleteUser( $packet['user_inet_login'] );
                        \app\components\COA::disconnect( $packet['user_inet_login'] );
                    }
